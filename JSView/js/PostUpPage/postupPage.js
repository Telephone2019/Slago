(function(){
    ...
    namespace.Page=[
        ...
        '            <!-- 第一张 -->',
        '            <div class="hoverPointer" style="width:180px;height:180px;background-color: #fafafa;border-radius: 10px;',
        ...
        '        <div class="hoverPointer" style="width:120px;height:60px;background-color: #0066cc;',
