(function(){
    ...
    namespace.template=[
    '<!--页面Header-->',
    '<div style="width:640px;height:150px;background-color:#ffffff;position:fixed;">',
    '    <!-- 标题与搜索栏 -->',
    ...
    '            <img src="./img/搜索.png" style="height:50px;border-top-right-radius: 25px;border-bottom-right-radius:25px ;margin-left: 10px;">',
    '        </div>',
    '    </div>',
    '    <!-- 页面内选择栏 -->',
    '    <div style="width:640px;height:50%;background-color: rgb(255, 255, 255);">',
    '        <!-- 字体栏 -->',
